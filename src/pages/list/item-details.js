...
export default class ItemDeatils extends React.Component {
    static propTypes = {
                ...
                <div className="col-xs-12">
                    <div className="panel panel-primary">
                        ...
                        <div className="panel-body">
                            <iframe src={ `https://www.youtube.com/embed/${ this.state.youtube }` } frameBorder='0' allowFullScreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
